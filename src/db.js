...
const receiptCompletionItems = [
  ["tx-001", "Family dinner ingredients", "Chicken, pasta sauce, rice, vegetables", "Tesco Allerton", "basket group", 24.5, "Groceries", "Sarah", "2024-05-30", ["dinner", "weekly-shop"]],
  ["tx-001", "Lunchbox snacks", "Yoghurt tubes, cereal bars, fruit packs", "Tesco Allerton", "basket group", 16.8, "Groceries", "Oliver", "2024-05-30", ["teen-snacks", "lunchbox"]],
  ["tx-001", "Household cleaning top-up", "Surface spray, sponges, bin bags", "Tesco Allerton", "basket group", 12.07, "Household", "Sarah", "2024-05-30", ["cleaning"]],
  ["tx-001", "Toiletries multipack", "Shampoo, shower gel, deodorant", "Tesco Allerton", "basket group", 9, "Toiletries", "Mia", "2024-05-30", ["toiletries"]],
  ["tx-001", "Fresh fruit and veg top-up", "Mixed vegetables and berries", "Tesco Allerton", "basket group", 10, "Groceries", "Sarah", "2024-05-30", ["fruit", "veg"]],
  ["tx-002", "Weekly produce bundle", "Fruit, salad, potatoes", "Aldi Wavertree", "basket group", 11.6, "Groceries", "Mark", "2024-05-29", ["produce"]],
  ["tx-002", "Meat and fish selection", "Chicken thighs, mince, fish fingers", "Aldi Wavertree", "basket group", 18.2, "Groceries", "Mark", "2024-05-29", ["protein"]],
  ["tx-002", "Store cupboard tins", "Beans, tomatoes, soup", "Aldi Wavertree", "basket group", 6.35, "Groceries", "Mark", "2024-05-29", ["staple"]],
  ["tx-002", "Bakery items", "Rolls and pastries", "Aldi Wavertree", "basket group", 3.6, "Groceries", "Mark", "2024-05-29", ["bakery"]],
  ["tx-002", "Carrier bags", "Reusable grocery bags", "Aldi Wavertree", "2 bags", 0.4, "Household", "Mark", "2024-05-29", ["charge"]],
  ["tx-003", "Family rail fares", "Liverpool day travel", "Merseyrail", "2 adult + 2 teen fares", 18.8, "Transport", "Oliver", "2024-05-28", ["rail", "family-travel"]],
  ["tx-004", "Pharmacy counter item", "Cold and flu sachets", "Boots", "1 pack", 4.29, "Pharmacy", "Mia", "2024-05-28", ["health"]],
  ["tx-004", "Toiletry travel minis", "Mini deodorant and tissues", "Boots", "2 items", 2.18, "Toiletries", "Mia", "2024-05-28", ["school-bag"]],
  ["tx-007", "Cleaning and storage items", "Foil, cloths, sandwich bags", "B&M", "basket group", 8.76, "Household", "Sarah", "2024-05-25", ["household"]],
  ["tx-007", "Teen stationery", "Pens and revision cards", "B&M", "basket group", 4.9, "Kids", "Mia", "2024-05-25", ["school"]],
  ["tx-008", "Weekly meal-plan groceries", "Protein, vegetables, pasta, rice", "Ocado", "basket group", 54.6, "Groceries", "Sarah", "2024-06-06", ["weekly-shop"]],
  ["tx-008", "Lunchbox and breakfast items", "Cereal, fruit, snacks, juice", "Ocado", "basket group", 31.25, "Groceries", "Sarah", "2024-06-06", ["lunchbox"]],
  ["tx-008", "Household staples", "Kitchen roll, dishwasher tablets, wipes", "Ocado", "basket group", 20.5, "Household", "Sarah", "2024-06-06", ["cleaning"]],
  ["tx-008", "Delivery and bag charge", "Delivery slot and bag recovery", "Ocado", "1 charge", 6.25, "Charges", "Sarah", "2024-06-06", ["delivery-charge"]],
  ["tx-009", "Discount grocery basket", "Meat, vegetables, dairy, tins", "Lidl Kensington", "basket group", 34.75, "Groceries", "Mark", "2024-06-13", ["weekly-shop"]],
  ["tx-009", "School snack top-up", "Snack bars, juice cartons, crisps", "Lidl Kensington", "basket group", 11.84, "Kids", "Oliver", "2024-06-13", ["lunchbox"]],
  ["tx-009", "Household consumables", "Toilet roll and cleaning spray", "Lidl Kensington", "basket group", 8.4, "Household", "Mark", "2024-06-13", ["household"]],
  ["tx-010", "Main family food shop", "Dinner ingredients and staples", "Asda Smithdown", "basket group", 48.39, "Groceries", "Sarah", "2024-07-04", ["weekly-shop"]],
  ["tx-010", "Teen packed-lunch items", "Wraps, fruit, crisps, yoghurt", "Asda Smithdown", "basket group", 18.5, "Kids", "Oliver", "2024-07-04", ["lunchbox"]],
  ["tx-010", "Laundry and bathroom supplies", "Detergent, tissues, shower gel", "Asda Smithdown", "basket group", 13.1, "Household", "Sarah", "2024-07-04", ["household"]],
  ["tx-010", "Carrier bags", "Reusable bags", "Asda Smithdown", "3 bags", 0.9, "Charges", "Sarah", "2024-07-04", ["bag-charge"]],
  ["tx-011", "Weekly groceries", "Fresh food and cupboard staples", "Sainsbury's Woolton", "basket group", 42.25, "Groceries", "Mark", "2024-07-18", ["weekly-shop"]],
  ["tx-011", "Dinner ingredients", "Fish, vegetables, rice, sauce", "Sainsbury's Woolton", "basket group", 15.87, "Groceries", "Mark", "2024-07-18", ["dinner"]],
  ["tx-011", "Household sundries", "Foil, washing liquid, soap", "Sainsbury's Woolton", "basket group", 10, "Household", "Sarah", "2024-07-18", ["household"]],
  ["tx-012", "Corner shop essentials", "Milk, bread, eggs, fruit", "Corner Shop Aigburth", "basket group", 8.4, "Groceries", "Sarah", "2024-08-03", ["top-up-shop"]],
  ["tx-012", "Emergency snack top-up", "Drinks and crisps", "Corner Shop Aigburth", "basket group", 4.76, "Kids", "Mia", "2024-08-03", ["corner-shop-premium"]],
  ["tx-013", "Family toiletries", "Shampoo, conditioner, shower gel", "Boots", "basket group", 11.27, "Toiletries", "Sarah", "2024-08-10", ["toiletries"]],
  ["tx-013", "Skincare and cotton pads", "Face wash, cotton pads, moisturiser", "Boots", "basket group", 6.1, "Toiletries", "Mia", "2024-08-10", ["mia"]],
  ["tx-013", "Boots Advantage price adjustment", "Promotional items and points balance", "Boots", "1 adjustment", 2.49, "Charges", "Sarah", "2024-08-10", ["receipt-adjustment"]],
  ["tx-014", "School stationery set", "Notebook, pens, folders", "Waterstones", "basket group", 8.49, "Books", "Oliver", "2024-09-02", ["school"]],
  ["tx-014", "Gift wrap and bookmark", "Bookmark and wrap", "Waterstones", "basket group", 6.5, "Books", "Mia", "2024-09-02", ["reading"]],
  ["tx-015", "Sports bottle and socks", "Training accessories", "Decathlon", "basket group", 8.5, "Activities", "Oliver", "2024-09-05", ["football"]],
  ["tx-015", "Dance hair kit", "Hair grips and bottle", "Decathlon", "basket group", 7, "Activities", "Mia", "2024-09-05", ["dance"]],
  ["tx-016", "DIY consumables", "Masking tape, filler, sandpaper", "B&Q", "basket group", 13.36, "DIY", "Mark", "2024-10-11", ["diy"]],
  ["tx-016", "Small tools", "Paint tray and scraper", "B&Q", "basket group", 6.49, "DIY", "Mark", "2024-10-11", ["repair"]],
  ["tx-018", "Teen schoolwear extras", "Socks, belt, shirts", "Next", "basket group", 16.5, "Clothing", "Oliver", "2024-11-01", ["school-uniform"]],
  ["tx-019", "Cleaning refill basket", "Bleach, cloths, bin liners", "Home Bargains", "basket group", 8.74, "Household", "Sarah", "2025-01-18", ["cleaning"]],
  ["tx-019", "Bathroom supplies", "Soap, toothpaste, tissues", "Home Bargains", "basket group", 5.89, "Toiletries", "Sarah", "2025-01-18", ["toiletries"]],
  ["tx-019", "Kitchen cupboard top-up", "Tea bags, biscuits, cereal", "Home Bargains", "basket group", 2.5, "Groceries", "Sarah", "2025-01-18", ["staple"]],
  ["tx-020", "Tesco weekly grocery basket", "Fresh food, meat, dairy, cupboard staples", "Tesco Allerton", "basket group", 61.4, "Groceries", "Mark", "2026-05-12", ["weekly-shop"]],
  ["tx-020", "Teen lunch and snack basket", "Lunch snacks, juice, fruit", "Tesco Allerton", "basket group", 19.96, "Kids", "Oliver", "2026-05-12", ["teen-snacks"]],
  ["tx-020", "Household and pet aisle", "Cleaning, dog treats, toiletries", "Tesco Allerton", "basket group", 20.78, "Household", "Sarah", "2026-05-12", ["household"]],
  ["tx-021", "Decorating supplies", "Brushes, dust sheet, adhesive", "The Range", "basket group", 18.77, "DIY", "Mark", "2025-03-08", ["diy"]],
  ["tx-021", "Home storage items", "Storage boxes and labels", "The Range", "basket group", 10.75, "Household", "Sarah", "2025-03-08", ["storage"]],
  ["tx-022", "Teen toiletries basket", "Hair spray, wipes, cotton pads", "Superdrug", "basket group", 8.95, "Toiletries", "Mia", "2025-04-12", ["mia"]],
  ["tx-022", "Make-up and skincare", "Mascara, cleanser, nail file", "Superdrug", "basket group", 10.27, "Toiletries", "Mia", "2025-04-12", ["personal"]],
  ["tx-023", "Sportswear basics", "Shorts and base layer", "Sports Direct", "basket group", 22, "Clothing", "Oliver", "2025-08-21", ["football"]],
  ["tx-023", "Delivery charge", "Standard delivery", "Sports Direct", "1 charge", 4.99, "Charges", "Oliver", "2025-08-21", ["delivery-charge"]],
  ["tx-023", "Training accessories", "Water bottle and grip tape", "Sports Direct", "basket group", 3.01, "Activities", "Oliver", "2025-08-21", ["sports"]],
  ["tx-025", "School stationery", "Pens and exam cards", "WHSmith", "basket group", 6, "Books", "Mia", "2026-02-03", ["school"]],
  ["tx-026", "Pet treats and grooming", "Dental sticks and grooming wipes", "Pets at Home", "basket group", 6.15, "Pets", "Scout", "2026-03-16", ["pet-care"]],
  ["tx-026", "Pet loyalty donation", "Till charity round-up", "Pets at Home", "1 charge", 0.79, "Charges", "Mark", "2026-03-16", ["round-up"]],
  ["tx-026", "Pet care accessory", "Collar tag replacement", "Pets at Home", "1 item", 3, "Pets", "Scout", "2026-03-16", ["pet-care"]],
  ["tx-027", "Frozen family meals", "Pizza, chips, fish fingers", "Iceland", "basket group", 24.2, "Groceries", "Sarah", "2026-04-19", ["freezer"]],
  ["tx-027", "Packed lunch freezer top-up", "Sausage rolls and snacks", "Iceland", "basket group", 15.5, "Kids", "Oliver", "2026-04-19", ["lunchbox"]],
  ["tx-027", "Household freezer staples", "Bread, milk, vegetables", "Iceland", "basket group", 18, "Groceries", "Sarah", "2026-04-19", ["staple"]],
  ["tx-030", "Emergency pet-food top-up", "Wet food trays", "Pets at Home", "basket group", 5.96, "Pets", "Mark", "2024-05-27", ["pet-food"]]
].map(([transactionId, item, variant, seller, quantity, lineTotal, category, buyer, purchasedAt, tags], index) => ({
  id: `ri-c-${String(index + 1).padStart(3, "0")}`,
  transactionId,
  item,
  variant,
  seller,
  ...
  tags,
  shrinkflation: false,
  productUrl: `local://seller/${seller.toLowerCase().replace(/[^a-z0-9]+/g, "-")}/${item.toLowerCase().replace(/[^a-z0-9]+/g, "-")}`
}));
